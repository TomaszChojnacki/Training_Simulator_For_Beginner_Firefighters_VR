Shader "Unreal/MI_Loading_Bay_Tarp"
{
    Properties
    {
		...
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.659375, 0.659375, 0.659375, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "MI_Loading_Bay_Tarp.hlsl"
