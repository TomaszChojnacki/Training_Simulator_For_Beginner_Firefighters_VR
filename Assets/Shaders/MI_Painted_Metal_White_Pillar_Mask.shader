Shader "Unreal/MI_Painted_Metal_White_Pillar_Mask"
{
    Properties
    {
		...
		Material_Texture2D_3( "T_Grunge_11", 2D ) = "white" {}
		Material_Texture2D_4( "ORME", 2D ) = "white" {}
		...
		Dirt_Color( "Dirt_Color", Color ) = (0.585069, 0.513856, 0.472321, 1.000000 )
		Dirt_Strength_Offset( "Dirt_Strength_Offset", Float ) = 0.828000
		...
		Highlight_Intensity( "Highlight_Intensity", Float ) = 0.800000
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 1.500000
		Roughness_Var_Amount( "Roughness_Var_Amount", Float ) = 0.700000
		Roughness_Var_Strength( "Roughness_Var_Strength", Float ) = 0.500000
		Dirt_Roughness_Amount( "Dirt_Roughness_Amount", Float ) = 0.000000
    ...
    SubShader
    {
        ...
        #include "MI_Painted_Metal_White_Pillar_Mask.hlsl"
