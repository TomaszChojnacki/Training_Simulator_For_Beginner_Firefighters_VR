Shader "Unreal/MI_Wrapped_Plastic"
{
    Properties
    {
		...
		Addon_Normal_Tilling( "Addon_Normal_Tilling", Float ) = 0.824000
		...
		Glass_Color( "Glass_Color", Color ) = (0.056044, 0.058234, 0.059028, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "MI_Wrapped_Plastic.hlsl"
