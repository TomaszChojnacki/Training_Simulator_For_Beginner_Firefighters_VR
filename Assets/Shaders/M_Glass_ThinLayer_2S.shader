Shader "Unreal/M_Glass_ThinLayer_2S"
{
    Properties
    {
		...
		Material_Texture2D_0( "WS_Roughness", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Glass_Color( "Glass_Color", Color ) = (0.006925, 0.031250, 0.024956, 1.000000 )
		Dust_Color( "Dust_Color", Color ) = (0.312500, 0.226795, 0.111150, 1.000000 )
		WS_Tilling( "WS_Tilling", Float ) = 50.000000
		Dust_Amount( "Dust_Amount", Float ) = 0.250000
		Dust_Roughness( "Dust_Roughness", Float ) = 0.850000
		Glass_Opacity( "Glass_Opacity", Float ) = 0.050000
		Refraction( "Refraction", Float ) = 1.100000
		RefractionDepthBias( "RefractionDepthBias", Float ) = -1.000000
		Scatter_Color( "Scatter_Color", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "M_Glass_ThinLayer_2S.hlsl"
