Shader "Unreal/MI_Painted_Metal_Gray"
{
    Properties
    {
		...
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.156250, 0.156250, 0.156250, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "MI_Painted_Metal_Gray.hlsl"
