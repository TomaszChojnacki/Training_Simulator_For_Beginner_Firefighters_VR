Shader "Unreal/MI_Concrete_Floor_Dark_WS"
{
    Properties
    {
		...
		Material_Texture2D_2( "Second Base Color", 2D ) = "white" {}
		Material_Texture2D_3( "Base Color Texture", 2D ) = "white" {}
		Material_Texture2D_4( "Second_Base_Color_Grunge", 2D ) = "white" {}
		Material_Texture2D_5( "Roughness", 2D ) = "white" {}
		Material_Texture2D_6( "Roughness_Grunge_01", 2D ) = "white" {}
		Material_Texture2D_7( "Roughness_Grunge_02", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		WS_Tilling( "WS_Tilling", Float ) = 400.000000
		Normal_Strength( "Normal_Strength", Float ) = 1.000000
		Detail_Normal_Tilling( "Detail_Normal_Tilling", Float ) = 1191.845215
		Detail_Normal_Strength( "Detail_Normal_Strength", Float ) = 0.100000
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Second_BaseColor_Grunge_Tilling( "Second_BaseColor_Grunge_Tilling", Float ) = 700.000000
		Second_BaseColor_Grunge_Strength( "Second_BaseColor_Grunge_Strength", Float ) = 0.309452
		Metallic_Constant( "Metallic_Constant", Float ) = 0.000000
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 0.600000
		R_Overall_Grunge_Power( "R_Overall_Grunge_Power", Float ) = 0.725333
		Roughness_Grunge_02_Amount( "Roughness_Grunge_02_Amount", Float ) = 0.800000
		Roughness_Grunge_01_Amount( "Roughness_Grunge_01_Amount", Float ) = 1.236462
		Roughness_Grunge_Tilling( "Roughness_Grunge_Tilling", Float ) = 676.058655
		R_01_Grunge_Power( "R_01_Grunge_Power", Float ) = -0.204118
		R_02_Grunge_Power( "R_02_Grunge_Power", Float ) = 0.317083
    ...
    SubShader
    {
        ...
        #include "MI_Concrete_Floor_Dark_WS.hlsl"
