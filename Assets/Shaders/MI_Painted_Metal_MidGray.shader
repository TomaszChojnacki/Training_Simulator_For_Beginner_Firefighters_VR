Shader "Unreal/MI_Painted_Metal_MidGray"
{
    Properties
    {
		...
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.593750, 0.593750, 0.593750, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "MI_Painted_Metal_MidGray.hlsl"
