Shader "Unreal/MI_Colored_Painted_Plaster1"
{
    Properties
    {
		...
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (1.000000, 0.428691, 0.104616, 1.000000 )
		...
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 1.800000
    ...
    SubShader
    {
        ...
        #include "MI_Colored_Painted_Plaster1.hlsl"
