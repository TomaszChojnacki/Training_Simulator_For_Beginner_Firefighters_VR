...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.219320,0.237774,0.255208,0.500000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.800000,0.000000,0.000000,0.000000);//(Unknown)
