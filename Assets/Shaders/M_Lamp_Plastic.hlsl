...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.882424,0.757044,0.100000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.350000,0.000000,0.000000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].x = SelectionColor.w;
	Material.PreshaderBuffer[0].yzw = SelectionColor.xyz;
	Material.PreshaderBuffer[1].xyz = Color_1.xyz;
	Material.PreshaderBuffer[1].w = Roughness;
	Material.PreshaderBuffer[2].x = Opacity;
	Material.PreshaderBuffer[2].y = __SubsurfaceProfile;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local1 = (GetShadowReplaceState() ? (0.00000000) : (1.00000000));

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[2].x;
	PixelMaterialInputs.OpacityMask = Local1;
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[1].xyz;
	PixelMaterialInputs.Metallic = 0.00000000;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[1].w;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = MaterialFloat3(0.00000000,0.00000000,1.00000000);
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[2].y);
