Shader "Unreal/MI_MM00170_Industrial_Ceiling_Light_On"
{
    Properties
    {
		...
		Emissive_Intencity( "Emissive_Intencity", Float ) = 1000.000000
		...
		Dust_Opacity( "Dust_Opacity", Float ) = 0.154667
    ...
    SubShader
    {
        ...
        #include "MI_MM00170_Industrial_Ceiling_Light_On.hlsl"
