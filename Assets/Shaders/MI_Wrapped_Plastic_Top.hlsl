...
{
	Material.PreshaderBuffer[0] = float4(0.400000,-1.000000,0.000000,-0.011017);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.083333,0.083333,0.083333,0.951114);//(Unknown)
