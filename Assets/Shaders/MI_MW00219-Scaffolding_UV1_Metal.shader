Shader "Unreal/MI_MW00219-Scaffolding_UV1_Metal"
{
    Properties
    {
		...
		Material_Texture2D_1( "Base Color Texture", 2D ) = "white" {}
		Material_Texture2D_2( "Mask Texture", 2D ) = "white" {}
		Material_Texture2D_3( "Dirt Breakup Texture", 2D ) = "white" {}
		Material_Texture2D_4( "T_Grunge_11", 2D ) = "white" {}
		Material_Texture2D_5( "ORME", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Texture_Tiling( "Texture_Tiling", Float ) = 7.000000
		Normal_Strength( "Normal_Strength", Float ) = 1.000000
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.852431, 0.905636, 1.000000, 1.000000 )
		Highlight_Color( "Highlight_Color", Color ) = (0.846238, 0.934888, 1.000000, 1.000000 )
		Highlight_Intensity( "Highlight_Intensity", Float ) = 1.000000
		Dirt_Color( "Dirt_Color", Color ) = (0.789931, 0.681463, 0.591077, 1.000000 )
		Dirt_Strength_Offset( "Dirt_Strength_Offset", Float ) = 0.616000
		Dirt_Breakup_Tiling( "Dirt_Breakup_Tiling", Float ) = 5.000000
		Dirt_Breakup_Texture_Contrast( "Dirt_Breakup_Texture_Contrast", Float ) = 1.000000
		Dust_Color( "Dust_Color", Color ) = (0.416667, 0.375210, 0.337095, 1.000000 )
		Dust_Falloff( "Dust_Falloff", Float ) = 2.000000
		Dust_Texture_Tiling( "Dust_Texture_Tiling", Float ) = 10.000000
		Dust_Texture_Contrast( "Dust_Texture_Contrast", Float ) = -0.800000
		Dust_Opacity( "Dust_Opacity", Float ) = 0.600000
		Edge_Highlight_Metallic( "Edge_Highlight_Metallic", Float ) = 0.000000
		Dirt_Metallic_Constant( "Dirt_Metallic_Constant", Float ) = 0.000000
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 1.500000
		Roughness_Var_Amount( "Roughness_Var_Amount", Float ) = 0.605486
		Roughness_Var_Strength( "Roughness_Var_Strength", Float ) = 0.248000
		Dirt_Roughness_Amount( "Dirt_Roughness_Amount", Float ) = 0.842667
		Dust_Roughness( "Dust_Roughness", Float ) = 0.900000
		Alpha_Constant( "Alpha_Constant", Float ) = 1.000000
		AO_Strength_Offset( "AO_Strength_Offset", Float ) = 0.500000
    ...
    SubShader
    {
        ...
        #include "MI_MW00219-Scaffolding_UV1_Metal.hlsl"
