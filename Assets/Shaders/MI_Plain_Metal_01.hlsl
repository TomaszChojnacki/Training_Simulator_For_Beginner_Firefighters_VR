...
uniform float4 Base_Color_Constant;
...
{
	Material.PreshaderBuffer[0] = float4(2.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.640803,0.683308,0.751736,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(-0.001843,0.348479,0.500000,0.624000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.272000,0.746667,0.430000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[2].xyz = Base_Color_Constant.xyz;
	Material.PreshaderBuffer[2].w = Round( Metallic_Constant );
	Material.PreshaderBuffer[3].x = rcp( Abs( Roughness_Grunge_Tilling ) * -1 );
	Material.PreshaderBuffer[3].y = R_01_Grunge_Power;
	Material.PreshaderBuffer[3].z = Roughness_Constant;
	Material.PreshaderBuffer[3].w = Roughness_Grunge_01_Amount;
	Material.PreshaderBuffer[4].x = R_02_Grunge_Power;
	Material.PreshaderBuffer[4].y = Roughness_Grunge_02_Amount;
	Material.PreshaderBuffer[4].z = R_Overall_Grunge_Power;
	Material.PreshaderBuffer[4].w = Alpha_Constant;
	Material.PreshaderBuffer[5].x = 1 - AO_Strength_Offset;
}
...
SHADER_DISABLE_WARNINGS
	...
	FWSVector3 Local9 = WSMultiply(DERIV_BASE_VALUE(Local8), ((MaterialFloat3)Material.PreshaderBuffer[3].x));
	...
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, Local11, 5);
	...
	MaterialFloat Local30 = MaterialStoreTexCoordScale(Parameters, Local29, 5);
	...
	MaterialFloat3 Local40 = PositiveClampedPow(Local39,((MaterialFloat3)Material.PreshaderBuffer[3].y));
	MaterialFloat Local41 = lerp(Material.PreshaderBuffer[3].w,Material.PreshaderBuffer[3].z,Local40.x);
	MaterialFloat Local42 = MaterialStoreTexCoordScale(Parameters, Local11, 8);
	MaterialFloat4 Local43 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(samplerMaterial_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local11));
	MaterialFloat Local44 = MaterialStoreTexSample(Parameters, Local43, 8);
	MaterialFloat Local45 = MaterialStoreTexCoordScale(Parameters, Local16, 8);
	MaterialFloat4 Local46 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(samplerMaterial_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local16));
	MaterialFloat Local47 = MaterialStoreTexSample(Parameters, Local46, 8);
	MaterialFloat3 Local48 = lerp(Local43.rgb,Local46.rgb,DERIV_BASE_VALUE(Local26));
	MaterialFloat Local49 = MaterialStoreTexCoordScale(Parameters, Local29, 8);
	MaterialFloat4 Local50 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(samplerMaterial_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local29));
	MaterialFloat Local51 = MaterialStoreTexSample(Parameters, Local50, 8);
	MaterialFloat3 Local52 = lerp(Local48,Local50.rgb,DERIV_BASE_VALUE(Local38));
	MaterialFloat3 Local53 = PositiveClampedPow(Local52,((MaterialFloat3)Material.PreshaderBuffer[4].x));
	MaterialFloat Local54 = lerp(Material.PreshaderBuffer[4].y,Local41,Local53.x);
	MaterialFloat Local55 = (Material.PreshaderBuffer[4].z * Local54);
	MaterialFloat Local56 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 3);
	MaterialFloat4 Local57 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local58 = MaterialStoreTexSample(Parameters, Local57, 3);
	MaterialFloat Local59 = PositiveClampedPow(Local57.r,Material.PreshaderBuffer[5].x);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Material.PreshaderBuffer[4].w;
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[2].xyz;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[2].w;
