Shader "Unreal/MI_Dark_Rubber"
{
    Properties
    {
		...
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.119575, 0.122706, 0.125000, 1.000000 )
		...
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 6.000000
