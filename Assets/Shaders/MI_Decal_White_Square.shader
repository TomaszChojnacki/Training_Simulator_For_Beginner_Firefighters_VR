Shader "Unreal/MI_Decal_White_Square"
{
    Properties
    {
		...
		Color_Overlay( "Color_Overlay", Color ) = (0.602430, 0.602430, 0.602430, 1.000000 )
		Roughness( "Roughness", Float ) = 0.700000
		Opacity( "Opacity", Float ) = 0.800000
    ...
    SubShader
    {
        ...
        #include "MI_Decal_White_Square.hlsl"
