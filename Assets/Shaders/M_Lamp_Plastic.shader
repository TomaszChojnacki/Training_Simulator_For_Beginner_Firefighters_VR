Shader "Unreal/M_Lamp_Plastic"
{
    Properties
    {
		...
		Color_1( "Color_1", Color ) = (1.000000, 0.882424, 0.757044, 0.000000 )
		Roughness( "Roughness", Float ) = 0.100000
		Opacity( "Opacity", Float ) = 0.350000
		__SubsurfaceProfile( "__SubsurfaceProfile", Float ) = -1.000000
