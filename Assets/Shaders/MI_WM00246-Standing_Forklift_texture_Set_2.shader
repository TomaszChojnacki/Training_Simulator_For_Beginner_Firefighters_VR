Shader "Unreal/MI_WM00246-Standing_Forklift_texture_Set_2"
{
    Properties
    {
		...
		Material_Texture2D_2( "Color_Mask", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_WM00246-Standing_Forklift_texture_Set_2.hlsl"
