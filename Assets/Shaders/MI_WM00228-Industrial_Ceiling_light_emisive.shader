Shader "Unreal/MI_WM00228-Industrial_Ceiling_light_emisive"
{
    Properties
    {
		...
		Emissive_Intencity( "Emissive_Intencity", Float ) = 10.000000
		Emissive_Constant( "Emissive_Constant", Vector ) = (1.000000, 0.810690, 0.612338, 1.000000 )
		Base_Color_Constant( "Base_Color_Constant", Color ) = (0.406250, 0.500000, 0.500000, 1.000000 )
		Metallic_Constant( "Metallic_Constant", Float ) = 0.400000
		Roughness_Constant( "Roughness_Constant", Float ) = 0.000000
    ...
    SubShader
    {
        ...
        #include "MI_WM00228-Industrial_Ceiling_light_emisive.hlsl"
