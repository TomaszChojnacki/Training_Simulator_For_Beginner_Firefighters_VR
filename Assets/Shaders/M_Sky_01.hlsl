...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[0].x = Sky_Brightness;
	Material.PreshaderBuffer[0].y = SelectionColor.w;
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local2 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local3 = MaterialStoreTexSample(Parameters, Local2, 0);
	MaterialFloat3 Local4 = (Local2.rgb * ((MaterialFloat3)Material.PreshaderBuffer[0].x));
	MaterialFloat3 Local5 = lerp(Local4,Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].y);
