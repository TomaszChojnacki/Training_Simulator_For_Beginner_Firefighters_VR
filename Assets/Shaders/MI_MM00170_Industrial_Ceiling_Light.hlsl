...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.000000,3.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(8.000000,7.000000,0.154667,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.588542,0.538502,0.492495,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.950000,1.000000,1.000000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local30 = lerp(Local29,Material.PreshaderBuffer[5].x,Local22);
	MaterialFloat Local31 = PositiveClampedPow(Local25.r,Material.PreshaderBuffer[5].z);
