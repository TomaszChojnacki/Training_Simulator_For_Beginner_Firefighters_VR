...
{
	Material.PreshaderBuffer[0] = float4(1.345420,0.070000,-1.000000,-0.011017);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.326372,0.339124,0.343750,0.100000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.200000,-0.004738,0.200000,0.150000);//(Unknown)
