Shader "Unreal/MI_Painted_Metal_Orange_Step_Plate"
{
    Properties
    {
		...
		Material_Texture2D_2( "T_Grunge_12", 2D ) = "white" {}
		Material_Texture2D_3( "ORMA(AO,Rough,Mat,Emis)", 2D ) = "white" {}
		Material_Texture2D_4( "Roughness_Grunge_01", 2D ) = "white" {}
		Material_Texture2D_5( "Roughness_Grunge_02", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Texture_Tiling( "Texture_Tiling", Float ) = 24.000000
		Normal_Strength( "Normal_Strength", Float ) = 1.000000
		Emissive_Intencity( "Emissive_Intencity", Float ) = 0.000000
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.863157, 0.187821, 0.025187, 1.000000 )
		Dust_Color( "Dust_Color", Color ) = (0.588542, 0.538502, 0.492495, 1.000000 )
		Dust_Falloff( "Dust_Falloff", Float ) = 3.000000
		Dust_Texture_Tiling( "Dust_Texture_Tiling", Float ) = 8.000000
		Dust_Texture_Contrast( "Dust_Texture_Contrast", Float ) = -6.000000
		Dust_Opacity( "Dust_Opacity", Float ) = 0.410667
		Metallic_Constant( "Metallic_Constant", Float ) = 0.000000
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 9.000000
    ...
    SubShader
    {
        ...
        #include "MI_Painted_Metal_Orange_Step_Plate.hlsl"
