Shader "Unreal/MI_WM00246-Standing_Forklift_texture_Set_1"
{
    Properties
    {
		...
		Material_Texture2D_1( "ORMA(AO,Rough,Mat,Emis)", 2D ) = "white" {}
		Material_Texture2D_2( "Base Color Texture", 2D ) = "white" {}
		Material_Texture2D_3( "Color_Mask", 2D ) = "white" {}
		Material_Texture2D_4( "T_Grunge_12", 2D ) = "white" {}
		...
		Emissive_Intencity( "Emissive_Intencity", Float ) = 1.000000
		Emissive_Constant( "Emissive_Constant", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.938686, 0.282292, 0.124180, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "MI_WM00246-Standing_Forklift_texture_Set_1.hlsl"
