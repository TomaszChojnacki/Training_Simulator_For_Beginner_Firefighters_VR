Shader "Unreal/MI_Decal_Dark_Streaks"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Decal", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Color_Overlay( "Color_Overlay", Color ) = (0.137153, 0.137153, 0.137153, 1.000000 )
		Roughness( "Roughness", Float ) = 1.000000
		Opacity( "Opacity", Float ) = 0.474667
    ...
    SubShader
    {
        ...
        #include "MI_Decal_Dark_Streaks.hlsl"
