Shader "Unreal/MI_White_Painted_Plaster"
{
    Properties
    {
		...
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 2.000000
		...
		Roughness_Grunge_Tilling( "Roughness_Grunge_Tilling", Float ) = 494.087402
    ...
    SubShader
    {
        ...
        #include "MI_White_Painted_Plaster.hlsl"
