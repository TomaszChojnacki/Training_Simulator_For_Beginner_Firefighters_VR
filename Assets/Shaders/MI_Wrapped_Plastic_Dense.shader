Shader "Unreal/MI_Wrapped_Plastic_Dense"
{
    Properties
    {
		...
		Addon_Normal_Tilling( "Addon_Normal_Tilling", Float ) = 1.345420
		Addon_Normal_Strength( "Addon_Normal_Strength", Float ) = 0.070000
		Addon_Normal_Strength_low( "Addon_Normal_Strength_low", Float ) = -1.000000
		WS_Tilling( "WS_Tilling", Float ) = 90.770287
		Glass_Color( "Glass_Color", Color ) = (0.326372, 0.339124, 0.343750, 1.000000 )
		...
		Glass_Opacity_Var( "Glass_Opacity_Var", Float ) = 0.150000
		Glass_Opacity( "Glass_Opacity", Float ) = 0.200000
    ...
    SubShader
    {
        ...
        #include "MI_Wrapped_Plastic_Dense.hlsl"
