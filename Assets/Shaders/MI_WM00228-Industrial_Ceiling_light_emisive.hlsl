...
{
	Material.PreshaderBuffer[0] = float4(10.000000,8.106900,6.123380,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.406250,0.500000,0.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,1.000000,0.000000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].xyz = Emissive_Intencity * Emissive_Constant.xyz;
	Material.PreshaderBuffer[0].w = SelectionColor.w;
	...
	Material.PreshaderBuffer[3].x = Roughness_Constant;
	Material.PreshaderBuffer[3].y = Alpha_Constant;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local0 = lerp(Material.PreshaderBuffer[0].xyz,Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].w);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Material.PreshaderBuffer[3].y;
	...
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[3].x;
