Shader "Unreal/MI_MW00219-Scaffolding_UV2"
{
    Properties
    {
		...
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.445201, 0.467784, 0.520996, 1.000000 )
		...
		Edge_Highlight_Metallic( "Edge_Highlight_Metallic", Float ) = 1.000000
		Dirt_Metallic_Constant( "Dirt_Metallic_Constant", Float ) = 0.000000
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 0.700000
    ...
    SubShader
    {
        ...
        #include "MI_MW00219-Scaffolding_UV2.hlsl"
