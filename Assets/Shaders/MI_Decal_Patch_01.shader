Shader "Unreal/MI_Decal_Patch_01"
{
    Properties
    {
		...
		Color_Overlay( "Color_Overlay", Color ) = (0.219320, 0.237774, 0.255208, 1.000000 )
		Roughness( "Roughness", Float ) = 0.500000
    ...
    SubShader
    {
        ...
        #include "MI_Decal_Patch_01.hlsl"
