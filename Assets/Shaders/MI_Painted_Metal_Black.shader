Shader "Unreal/MI_Painted_Metal_Black"
{
    Properties
    {
		...
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.050766, 0.055735, 0.059375, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "MI_Painted_Metal_Black.hlsl"
