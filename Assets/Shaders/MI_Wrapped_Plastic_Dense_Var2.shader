Shader "Unreal/MI_Wrapped_Plastic_Dense_Var2"
{
    Properties
    {
		...
		Material_Texture2D_0( "Addon_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Addon_Normal_Breakup", 2D ) = "white" {}
		Material_Texture2D_2( "Opacity_Variation_Grunge", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Addon_Normal_Tilling( "Addon_Normal_Tilling", Float ) = 3.306232
		Addon_Normal_Strength( "Addon_Normal_Strength", Float ) = -1.000000
		Addon_Normal_Strength_low( "Addon_Normal_Strength_low", Float ) = 0.000000
		WS_Tilling( "WS_Tilling", Float ) = 113.737411
		Glass_Color( "Glass_Color", Color ) = (0.059340, 0.061659, 0.062500, 1.000000 )
		Overall_Roughness_Amount( "Overall_Roughness_Amount", Float ) = 0.200000
		Grunge_Roughness_Power( "Grunge_Roughness_Power", Float ) = 0.100000
		Glass_Opacity_Var( "Glass_Opacity_Var", Float ) = 0.030000
		Glass_Opacity( "Glass_Opacity", Float ) = 0.122000
		WS_OP_Var_Tilling( "WS_OP_Var_Tilling", Float ) = 211.047928
		Refraction( "Refraction", Float ) = 0.500000
		RefractionDepthBias( "RefractionDepthBias", Float ) = 0.000000
		Scatter_Color( "Scatter_Color", Color ) = (0.939236, 0.961293, 1.000000, 1.000000 )
    ...
    SubShader
    {
        //BLEND_OFF      Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="Opaque" "UniversalMaterialType" = "Lit" "Queue"="Transparent" }
        ...
        #include "MI_Wrapped_Plastic_Dense_Var2.hlsl"
