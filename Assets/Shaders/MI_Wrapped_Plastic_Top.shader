Shader "Unreal/MI_Wrapped_Plastic_Top"
{
    Properties
    {
		...
		Addon_Normal_Tilling( "Addon_Normal_Tilling", Float ) = 0.400000
		...
		Glass_Color( "Glass_Color", Color ) = (0.083333, 0.083333, 0.083333, 1.000000 )
		Overall_Roughness_Amount( "Overall_Roughness_Amount", Float ) = 0.020000
		Grunge_Roughness_Power( "Grunge_Roughness_Power", Float ) = 0.951114
		Glass_Opacity_Var( "Glass_Opacity_Var", Float ) = 0.050000
		Glass_Opacity( "Glass_Opacity", Float ) = 0.010000
    ...
    SubShader
    {
        ...
        #include "MI_Wrapped_Plastic_Top.hlsl"
