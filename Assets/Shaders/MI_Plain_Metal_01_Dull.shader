Shader "Unreal/MI_Plain_Metal_01_Dull"
{
    Properties
    {
		...
		Material_Texture2D_1( "Roughness_Grunge_01", 2D ) = "white" {}
		Material_Texture2D_2( "Roughness_Grunge_02", 2D ) = "white" {}
		...
		Texture_Tiling( "Texture_Tiling", Float ) = 2.000000
		Normal_Strength( "Normal_Strength", Float ) = 1.000000
		Emissive_Intencity( "Emissive_Intencity", Float ) = 0.000000
		Base_Color_Constant( "Base_Color_Constant", Color ) = (0.640803, 0.683308, 0.751736, 1.000000 )
		Metallic_Constant( "Metallic_Constant", Float ) = 1.000000
		R_Overall_Grunge_Power( "R_Overall_Grunge_Power", Float ) = 0.430000
		Roughness_Grunge_02_Amount( "Roughness_Grunge_02_Amount", Float ) = 0.746667
		Roughness_Grunge_01_Amount( "Roughness_Grunge_01_Amount", Float ) = 0.624000
		Roughness_Constant( "Roughness_Constant", Float ) = 1.000000
		Roughness_Grunge_Tilling( "Roughness_Grunge_Tilling", Float ) = 542.531982
		R_01_Grunge_Power( "R_01_Grunge_Power", Float ) = 0.348479
		R_02_Grunge_Power( "R_02_Grunge_Power", Float ) = 0.394667
    ...
    SubShader
    {
        ...
        #include "MI_Plain_Metal_01_Dull.hlsl"
