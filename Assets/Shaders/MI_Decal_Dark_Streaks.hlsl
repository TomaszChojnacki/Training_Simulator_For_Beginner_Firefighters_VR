...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.137153,0.137153,0.137153,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.474667,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[2].x = Opacity;
	Material.PreshaderBuffer[2].y = RefractionDepthBias;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local5 = PositiveClampedPow(Material.PreshaderBuffer[1].w,Material.PreshaderBuffer[1].w);
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local7 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local8 = MaterialStoreTexSample(Parameters, Local7, 0);
	MaterialFloat Local9 = (Material.PreshaderBuffer[2].x * Local7.a);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = Local9;
