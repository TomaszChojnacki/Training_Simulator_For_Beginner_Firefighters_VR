Shader "Unreal/MI_Line_Solid_Yellow"
{
    Properties
    {
		...
		Material_Texture2D_1( "Decal", 2D ) = "white" {}
		Material_Texture2D_2( "Dirt_Breakup_Grunge", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Color_Overlay( "Color_Overlay", Color ) = (1.000000, 0.830314, 0.039631, 1.000000 )
		Roughness( "Roughness", Float ) = 0.800000
		Dirt_Breakup_Grunge_Strength( "Dirt_Breakup_Grunge_Strength", Float ) = 0.000000
		Grunge_Opacity( "Grunge_Opacity", Float ) = 17.674273
		Dirt_Breakup_Grunge_Tilling( "Dirt_Breakup_Grunge_Tilling", Float ) = 379.745605
		Opacity( "Opacity", Float ) = 1.000000
    ...
    SubShader
    {
        ...
        #include "MI_Line_Solid_Yellow.hlsl"
