Shader "Unreal/MI_WM00216-Wrapped_Boxes_Pieces_Var"
{
    Properties
    {
		...
		Texture_Tiling( "Texture_Tiling", Float ) = 1.000000
		Normal_Strength( "Normal_Strength", Float ) = 1.000000
		Emissive_Intencity( "Emissive_Intencity", Float ) = 0.000000
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.854993, 0.814847, 0.879623, 1.000000 )
		Dust_Color( "Dust_Color", Color ) = (0.356400, 0.300544, 0.250158, 1.000000 )
		Dust_Falloff( "Dust_Falloff", Float ) = 2.000000
		Dust_Texture_Tiling( "Dust_Texture_Tiling", Float ) = 3.000000
		Dust_Texture_Contrast( "Dust_Texture_Contrast", Float ) = 0.700000
		Dust_Opacity( "Dust_Opacity", Float ) = 0.500000
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 0.850000
		R_Overall_Grunge_Power( "R_Overall_Grunge_Power", Float ) = 0.893333
		Roughness_Grunge_02_Amount( "Roughness_Grunge_02_Amount", Float ) = 0.490667
		Roughness_Grunge_01_Amount( "Roughness_Grunge_01_Amount", Float ) = 0.800000
		Roughness_Grunge_Tilling( "Roughness_Grunge_Tilling", Float ) = 400.000000
		R_01_Grunge_Power( "R_01_Grunge_Power", Float ) = 1.160409
		R_02_Grunge_Power( "R_02_Grunge_Power", Float ) = 0.463684
    ...
    SubShader
    {
        ...
        #include "MI_WM00216-Wrapped_Boxes_Pieces_Var.hlsl"
