Shader "Unreal/MI_Painted_Metal_White_Center_Pillar"
{
    Properties
    {
		...
		Material_Texture2D_1( "Detail Normal Texture", 2D ) = "white" {}
		Material_Texture2D_2( "Base Color Texture", 2D ) = "white" {}
		Material_Texture2D_3( "T_Grunge_12", 2D ) = "white" {}
		Material_Texture2D_4( "ORMA(AO,Rough,Mat,Emis)", 2D ) = "white" {}
		Material_Texture2D_5( "Roughness_Grunge_01", 2D ) = "white" {}
		Material_Texture2D_6( "Roughness_Grunge_02", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Texture_Tiling( "Texture_Tiling", Float ) = 3.000000
		Normal_Strength( "Normal_Strength", Float ) = 1.000000
		Detail_Texture_Tiling( "Detail_Texture_Tiling", Float ) = 1.000000
		Detail_Normal_Strength( "Detail_Normal_Strength", Float ) = 0.500000
		Emissive_Intencity( "Emissive_Intencity", Float ) = 0.000000
		Base_Color_Multiplier( "Base_Color_Multiplier", Color ) = (0.854993, 0.938686, 1.000000, 1.000000 )
		Dust_Color( "Dust_Color", Color ) = (0.588542, 0.538502, 0.492495, 1.000000 )
		Dust_Falloff( "Dust_Falloff", Float ) = 0.372981
		Dust_Texture_Tiling( "Dust_Texture_Tiling", Float ) = 8.000000
		Dust_Texture_Contrast( "Dust_Texture_Contrast", Float ) = -6.000000
		Dust_Opacity( "Dust_Opacity", Float ) = 0.994667
		Metallic_Constant( "Metallic_Constant", Float ) = 0.000000
		Roughness_Multiplier( "Roughness_Multiplier", Float ) = 3.000000
		R_Overall_Grunge_Power( "R_Overall_Grunge_Power", Float ) = 0.330666
		Roughness_Grunge_02_Amount( "Roughness_Grunge_02_Amount", Float ) = 0.800000
		Roughness_Grunge_01_Amount( "Roughness_Grunge_01_Amount", Float ) = 0.800000
		Roughness_Grunge_Tilling( "Roughness_Grunge_Tilling", Float ) = 240.287888
		R_01_Grunge_Power( "R_01_Grunge_Power", Float ) = 0.231358
		R_02_Grunge_Power( "R_02_Grunge_Power", Float ) = 0.639646
		Dust_Roughness( "Dust_Roughness", Float ) = 0.950000
		AO_Strength_Offset( "AO_Strength_Offset", Float ) = 0.000000
    ...
    SubShader
    {
        ...
        #include "MI_Painted_Metal_White_Center_Pillar.hlsl"
