...
{
	Material.PreshaderBuffer[0] = float4(0.824000,-1.000000,0.000000,-0.011017);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.056044,0.058234,0.059028,0.951114);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.020000,-0.004738,0.010000,0.050000);//(Unknown)
