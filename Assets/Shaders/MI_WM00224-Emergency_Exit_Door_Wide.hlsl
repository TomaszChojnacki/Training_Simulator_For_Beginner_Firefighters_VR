...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2].w = Roughness_Multiplier;
	Material.PreshaderBuffer[3].x = Alpha_Constant;
	Material.PreshaderBuffer[3].y = 1 - AO_Strength_Offset;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	...
	MaterialFloat Local15 = PositiveClampedPow(Local12.r,Material.PreshaderBuffer[3].y);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Material.PreshaderBuffer[3].x;
